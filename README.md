...
query pacing, 30-minute incremental RADIUS reporting, hourly performance reporting,
...
RADIUS normally scans only its new 30-minute event window and performs a full
