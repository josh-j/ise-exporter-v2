...
VIEW_CONTRACTS = {
    ...
    }, optional={"FRAMED_IP_ADDRESS", "AUTHORIZATION_POLICY"},
    ...
    "ENDPOINTS_DATA": _view({
        "ID", "MAC_ADDRESS", "ENDPOINT_POLICY", "IDENTITY_GROUP_ID",
        "POSTURE_APPLICABLE",
    }, optional={"ENDPOINT_ID", "ENDPOINT_IP", "HOSTNAME", "PORTAL_USER", "PROFILE_SERVER",
                 "CREATE_TIME", "UPDATE_TIME"}, domain="endpoints"),
